class ExpenseTypesController < ApplicationController
  ...
  def index
    ...
    @active_expense_types = ExpenseType.active
  end
  ...
  def create
    ...
    respond_to do |format|
      if @expense_type.save
        format.html { redirect_to expense_types_url, notice: 'Expense type was successfully created.' }
  ...
  private
    ...
    def expense_type_params
      params.require(:expense_type).permit(:name, :active)
    end
end
