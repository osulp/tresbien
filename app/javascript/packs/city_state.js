$(document)
  .on('load change', '#states-of-country', function(e) {
    console.log('Querying cities for selected state.');
    var cities_of_state = $(this)
      .parents('td')
      .find('#cities-of-state');
    var country = $(this)
      .parents('td')
      .find('#countries-of-world')
      .children(':selected')
      .data('abbreviation');
...
$(document)
  .on('load change', '#countries-of-world', function(e) {
    console.log('Querying states of a country.');
    var cities_of_state = $(this)
      .parents('tr')
      .find('#cities-of-state');
    var states_of_country = $(this)
      .parents('tr')
      .find('#states-of-country');
    var country = $(this)
      .children(':selected')
      .data('abbreviation');
    var country_value = $(this)
      .children(':selected')
      .val();
    $.ajax({
      url: `/states/${country}`,
