...
class ExpenseTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create expense_type" do
    assert_difference('ExpenseType.count') do
      post expense_types_url, params: { expense_type: { active: @expense_type.active, name: @expense_type.name } }
    end
  ...
  test "should update expense_type" do
    patch expense_type_url(@expense_type), params: { expense_type: { active: @expense_type.active, name: @expense_type.name } }
